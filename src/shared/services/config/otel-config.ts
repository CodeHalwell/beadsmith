 ...
 * - BEADSMITH_OTEL_TELEMETRY_ENABLED: "1" to enable OpenTelemetry (default: off)
 * - BEADSMITH_OTEL_METRICS_EXPORTER: Comma-separated list: "console", "otlp", "prometheus"
 * - BEADSMITH_OTEL_LOGS_EXPORTER: Comma-separated list: "console", "otlp"
 * - BEADSMITH_OTEL_EXPORTER_OTLP_PROTOCOL: "grpc", "http/json", or "http/protobuf"
 * - BEADSMITH_OTEL_EXPORTER_OTLP_ENDPOINT: OTLP collector endpoint (if not using specific endpoints)
 * - BEADSMITH_OTEL_EXPORTER_OTLP_METRICS_PROTOCOL: Metrics-specific protocol override
 * - BEADSMITH_OTEL_EXPORTER_OTLP_METRICS_ENDPOINT: Metrics-specific endpoint override
 * - BEADSMITH_OTEL_EXPORTER_OTLP_LOGS_PROTOCOL: Logs-specific protocol override
 * - BEADSMITH_OTEL_EXPORTER_OTLP_LOGS_ENDPOINT: Logs-specific endpoint override
 * - BEADSMITH_OTEL_METRIC_EXPORT_INTERVAL: Milliseconds between metric exports (default: 60000)
 * - BEADSMITH_OTEL_EXPORTER_OTLP_INSECURE: "true" to disable TLS for gRPC (for local development)
 * - BEADSMITH_OTEL_LOG_BATCH_SIZE: Maximum batch size for log records (default: 512)
 * - BEADSMITH_OTEL_LOG_BATCH_TIMEOUT: Maximum time to wait before exporting logs in ms (default: 5000)
 * - BEADSMITH_OTEL_LOG_MAX_QUEUE_SIZE: Maximum queue size for log records (default: 2048)
 *
 * @private
